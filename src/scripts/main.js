(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".skills .skills-item, .bars .bars-item").each(function () {
      console.log("%csrc/scripts/main.js:220 object", "color: #007acc;", "hello");
    ...
    $(".contact-form").submit(function (e) {
      ...
      if ($form.valid()) {
        ...
        $.ajax({
          ...
          success: function () {
            $submit.before(
              '<div class="message message-success">Your message was sent successfully!</div>'
            );
          },
          error: function () {
            $submit.before(
              '<div class="message message-error">Your message wasn\'t sent, please try again.</div>'
            );
          },
          complete: function () {
